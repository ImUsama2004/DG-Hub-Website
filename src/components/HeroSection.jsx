    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <section className="relative h-screen min-h-150 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-green-900/60 mix-blend-color" />
        </div>
        ...
        <div className="container relative z-10 px-4 flex flex-col items-center text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs font-medium text-white mb-6 backdrop-blur-sm">
              ...
              We are now available All Time
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white max-w-4xl mx-auto">
              Build faster with <span className="text-green-500">modern developer tools</span>
            </h1>

            <p className="mt-6 text-base sm:text-lg text-white/80 max-w-2xl mx-auto">
              <span className="text-green-500 font-bold">DG Hub</span> provides a powerful platform for building, deploying, and
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to={'contact'}>
              <button className="cursor-pointer px-6 py-3 bg-green-500 rounded hover:bg-green-600 transition flex items-center gap-1">
                Contact
                <ArrowRight className="h-4 w-4" />
              </button>
                </Link>
              <Link to={'services'}>
              <button className="cursor-pointer px-6 py-3 border border-white/30 rounded hover:bg-white/10 transition">
                Our Products
              </button></Link>
            </div>
          </motion.div>
